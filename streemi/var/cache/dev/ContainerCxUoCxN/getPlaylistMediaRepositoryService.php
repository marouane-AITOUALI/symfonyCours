 ...
 */
class getPlaylistMediaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlaylistMediaRepository' shared autowired service.
     *
     * @return \App\Repository\PlaylistMediaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlaylistMediaRepository.php';

        return $container->privates['App\\Repository\\PlaylistMediaRepository'] = new \App\Repository\PlaylistMediaRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
