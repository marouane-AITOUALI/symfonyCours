 ...
 */
class getSubscriptionHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SubscriptionHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\SubscriptionHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubscriptionHistoryRepository.php';

        return $container->privates['App\\Repository\\SubscriptionHistoryRepository'] = new \App\Repository\SubscriptionHistoryRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
