 ...
 */
class getCategoryMediaRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryMediaRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryMediaRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryMediaRepository.php';

        return $container->privates['App\\Repository\\CategoryMediaRepository'] = new \App\Repository\CategoryMediaRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
