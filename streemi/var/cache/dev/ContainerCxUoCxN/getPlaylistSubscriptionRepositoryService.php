 ...
 */
class getPlaylistSubscriptionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlaylistSubscriptionRepository' shared autowired service.
     *
     * @return \App\Repository\PlaylistSubscriptionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlaylistSubscriptionRepository.php';

        return $container->privates['App\\Repository\\PlaylistSubscriptionRepository'] = new \App\Repository\PlaylistSubscriptionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
