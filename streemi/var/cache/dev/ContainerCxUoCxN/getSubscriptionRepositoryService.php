...
class getSubscriptionRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SubscriptionRepository.php';

        return $container->privates['App\\Repository\\SubscriptionRepository'] = new \App\Repository\SubscriptionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
