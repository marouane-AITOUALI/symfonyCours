 ...
 */
class getWatchHistoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\WatchHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\WatchHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WatchHistoryRepository.php';

        return $container->privates['App\\Repository\\WatchHistoryRepository'] = new \App\Repository\WatchHistoryRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
