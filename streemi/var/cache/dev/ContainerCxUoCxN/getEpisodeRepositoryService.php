 ...
 */
class getEpisodeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EpisodeRepository' shared autowired service.
     *
     * @return \App\Repository\EpisodeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EpisodeRepository.php';

        return $container->privates['App\\Repository\\EpisodeRepository'] = new \App\Repository\EpisodeRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
