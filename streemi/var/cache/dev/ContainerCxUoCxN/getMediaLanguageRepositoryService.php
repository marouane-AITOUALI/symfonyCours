...
class getMediaLanguageRepositoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MediaLanguageRepository.php';

        return $container->privates['App\\Repository\\MediaLanguageRepository'] = new \App\Repository\MediaLanguageRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
