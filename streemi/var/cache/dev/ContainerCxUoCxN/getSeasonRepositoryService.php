 ...
 */
class getSeasonRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SeasonRepository.php';

        return $container->privates['App\\Repository\\SeasonRepository'] = new \App\Repository\SeasonRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
