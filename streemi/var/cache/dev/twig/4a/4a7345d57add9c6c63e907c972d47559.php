...
/* index.html.twig */
class __TwigTemplate_d63f067a44a21bff220a6f9edca1339f extends Template
{
...
<div class=\"flex min-h-screen  2xl:max-w-screen-2xl 2xl:mx-auto 2xl:border-x-2 2xl:border-gray-200\">
    ...
    <main class=\" flex-1 py-10  px-5 sm:px-10 \">
        ...
        <section class=\"mt-9\">
            ...
            <ul class=\"mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5 \">
                ";
        // line 89
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 89)->unwrap()->yield($context);
        // line 90
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 90)->unwrap()->yield($context);
        // line 91
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 91)->unwrap()->yield($context);
        // line 92
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 92)->unwrap()->yield($context);
        // line 93
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 93)->unwrap()->yield($context);
        // line 94
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 94)->unwrap()->yield($context);
        // line 95
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 95)->unwrap()->yield($context);
        // line 96
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 96)->unwrap()->yield($context);
        // line 97
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 97)->unwrap()->yield($context);
        // line 98
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 98)->unwrap()->yield($context);
        // line 99
        yield "                ";
        yield from         $this->loadTemplate("parts/movie_card_homepage.html.twig", "index.html.twig", 99)->unwrap()->yield($context);
        // line 100
        yield "            </ul>
        </section>
    </main>
    ...
    ";
        // line 104
        yield from         $this->loadTemplate("parts/right-sidebar.html.twig", "index.html.twig", 104)->unwrap()->yield($context);
        // line 105
        yield "
</div>
...
";
    ...
    {
        return array (  178 => 105,  176 => 104,  170 => 100,  167 => 99,  164 => 98,  161 => 97,  158 => 96,  155 => 95,  152 => 94,  149 => 93,  146 => 92,  143 => 91,  140 => 90,  138 => 89,  64 => 17,  62 => 16,  45 => 1,);
    }
...
<div class=\"flex min-h-screen  2xl:max-w-screen-2xl 2xl:mx-auto 2xl:border-x-2 2xl:border-gray-200\">
    ...
    <main class=\" flex-1 py-10  px-5 sm:px-10 \">
        ...
        <section class=\"mt-9\">
            ...
            <ul class=\"mt-4 grid grid-cols-2 gap-y-5 sm:grid-cols-3 gap-x-5 \">
                {% include 'parts/movie_card_homepage.html.twig' %}
                {% include 'parts/movie_card_homepage.html.twig' %}
                {% include 'parts/movie_card_homepage.html.twig' %}
                {% include 'parts/movie_card_homepage.html.twig' %}
                {% include 'parts/movie_card_homepage.html.twig' %}
...
", "index.html.twig", "C:\\Users\\aitou\\OneDrive\\Bureau\\esgi_cours\\symfony\\cours-symfony-main\\streemi\\templates\\index.html.twig");
    }
}
