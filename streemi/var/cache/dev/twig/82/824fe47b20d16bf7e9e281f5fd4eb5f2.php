...
class __TwigTemplate_0d03e0eb38c4921a708ba12f908fd029 extends Template
{
...
<head>
    ...
    <title>Streemi - Inscription</title>
            ...
            <div style=\"background-image: url('https://blog.compose.fr/wp-content/uploads/2024/05/Marathon-Cinema.webp')\" class=\"bg-cover bg-no-repeat h-full before:bg-black/40 before:content-[''] before:top-0 before:left-0 before:right-0 before:absolute before:w-full before:h-full\">
                <div class=\"p-8 lg:w-1/2 mx-auto h-full flex items-center justify-center\">
                    <div class=\"bg-white rounded-lg p-8 relative w-full\">
                        <h1 class=\"text-center text-lg font-bold\">S'inscrire avec</h1>
                        ...
                        <p class=\"text-center text-sm font-medium mt-10\"> Ou utilisez vos informations :</p>
                        <form class=\"mt-10 space-y-3\">
                            <div class=\"relative\">
                                <input class=\"w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"firstname\" type=\"text\" placeholder=\"Prénom\"/>
                            </div>
                            <div class=\"relative\">
                                <input class=\"w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"email\" type=\"text\" placeholder=\"Adresse Email\"/>
                            </div>
                            <div class=\"relative\">
                                <input class=\"w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"phoneNumber\" type=\"text\" placeholder=\"Numéro de téléphone\"/>
                            </div>

                            <div class=\"relative\">
                                <input class=\"w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"address\" type=\"text\" placeholder=\"Adresse\"/>
                            </div>
                            <div class=\"relative flex space-x-3\">
                                <input class=\"w-1/2 px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"postalCode\" type=\"text\" placeholder=\"Code Postal\"/>
                                <input class=\"w-1/2 px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"city\" type=\"text\" placeholder=\"Ville\"/>
                            </div>
                            ...
                            <div class=\"relative\">
                                <input class=\"w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white\" id=\"repeated-password\" type=\"password\" placeholder=\"Confirmez votre Mot de passe\"/>
                                <button class=\"absolute right-2 inset-y-0 flex items-center px-2 opacity-50 hover:opacity-100 transition\">
                                    <svg class=\"h-5 w-5 fill-current\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><title>eye</title><path d=\"M12,9A3,3 0 0,0 9,12A3,3 0 0,0 12,15A3,3 0 0,0 15,12A3,3 0 0,0 12,9M12,17A5,5 0 0,1 7,12A5,5 0 0,1 12,7A5,5 0 0,1 17,12A5,5 0 0,1 12,17M12,4.5C7,4.5 2.73,7.61 1,12C2.73,16.39 7,19.5 12,19.5C17,19.5 21.27,16.39 23,12C21.27,7.61 17,4.5 12,4.5Z\" /></svg>
                                </button>
                            </div>
                            <div class=\"relative\">
                                <input type=\"checkbox\" id=\"terms\" name=\"terms\" value=\"terms\" class=\"mr-2 \"> <label for=\"terms\" class=\"text-sm\">J'accepte les <a href=\"#\" class=\"text-red-600\">conditions d'utilisation</a> et la <a href=\"#\" class=\"text-red-600\">politique de confidentialité</a></label>
                            </div>
                            <div class=\"flex items-center justify-center !mt-8\">
                                <button class=\"relative flex w-full bg-red-600 flex-row p-3 items-center justify-center rounded-lg overflow-hidden border cursor-pointer transition text-white hover:opacity-90 hover:scale-105\">
                                    <svg class=\"h-5 w-5 fill-current mr-2\" xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 24 24\"><title>account-plus</title><path d=\"M15,14C12.33,14 7,15.33 7,18V20H23V18C23,15.33 17.67,14 15,14M6,10V7H4V10H1V12H4V15H6V12H9V10M15,12A4,4 0 0,0 19,8A4,4 0 0,0 15,4A4,4 0 0,0 11,8A4,4 0 0,0 15,12Z\" /></svg>
                                    S'inscrire
                                </button>
                            </div>
...
", "auth/register.html.twig", "C:\\Users\\aitou\\OneDrive\\Bureau\\esgi_cours\\symfony\\cours-symfony-main\\streemi\\templates\\auth\\register.html.twig");
    }
}
