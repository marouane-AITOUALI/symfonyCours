...
class __TwigTemplate_a66d6801630d9f2ccd386ee23d109a10 extends Template
{
    ...
    <div class=\"mt-10\">
        ...
        <ul class=\"mt-4 text-gray-400 text-xs space-y-3\">
            ";
        // line 13
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 13)->unwrap()->yield($context);
        // line 14
        yield "            ";
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 14)->unwrap()->yield($context);
        // line 15
        yield "            ";
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 15)->unwrap()->yield($context);
        // line 16
        yield "            <li class=\"pt-1\">
    ...
    <div class=\"mt-10\">
        ...
        <ul class=\"mt-4 text-gray-400 text-xs space-y-3\">
            ";
        // line 24
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 24)->unwrap()->yield($context);
        // line 25
        yield "            ";
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 25)->unwrap()->yield($context);
        // line 26
        yield "            ";
        yield from         $this->loadTemplate("parts/movie_card_sidebar.html.twig", "parts/right-sidebar.html.twig", 26)->unwrap()->yield($context);
        // line 27
        yield "            <li class=\"pt-1\">
                <a href=\"#\" class=\"px-5 py-2.5 bg-red-600 hover:bg-red-700 rounded-lg text-center font-medium block text-white\">En afficher +</a>
            </li>
...
";
    ...
    {
        return array (  85 => 27,  82 => 26,  79 => 25,  77 => 24,  67 => 16,  64 => 15,  61 => 14,  59 => 13,  45 => 1,);
    }
    ...
    <div class=\"mt-10\">
        <span class=\"font-semibold text-gray-700\">Mes films en cours</span>
        <ul class=\"mt-4 text-gray-400 text-xs space-y-3\">
            {% include 'parts/movie_card_sidebar.html.twig' %}
            {% include 'parts/movie_card_sidebar.html.twig' %}
            {% include 'parts/movie_card_sidebar.html.twig' %}
            <li class=\"pt-1\">
                <a href=\"#\" class=\"px-5 py-2.5 bg-red-600  hover:bg-red-700 rounded-lg text-center font-medium block text-white\">En afficher +</a>
...
", "parts/right-sidebar.html.twig", "C:\\Users\\aitou\\OneDrive\\Bureau\\esgi_cours\\symfony\\cours-symfony-main\\streemi\\templates\\parts\\right-sidebar.html.twig");
    }
}
